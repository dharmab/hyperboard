...
func TestTagAliasUniqueConstraintErrors(t *testing.T) {
	if testDB == nil {
	...
	tests := []struct {
	...
	}{
		{
			...
			conflictMods: func(ctx context.Context, t *testing.T, exec bob.Executor, obj *models.TagAlias) factory.TagAliasModSlice {
				...
				return factory.TagAliasModSlice{
					factory.TagAliasMods.ID(obj.ID),
				}
			},
		},
		{
			...
			conflictMods: func(ctx context.Context, t *testing.T, exec bob.Executor, obj *models.TagAlias) factory.TagAliasModSlice {
				...
				return factory.TagAliasModSlice{
					factory.TagAliasMods.AliasName(obj.AliasName),
				}
			},
		},
	}
